...
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Trắng');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Đen');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Xám');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Xám Đen');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Xanh Đậm');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Xanh Nhạt');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Xanh Aqua');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Xanh Navy');
INSERT INTO `Colours` (`colour_id`, `colour_name`) VALUES (NULL, 'Xanh Rêu');

INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, 'S');
INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, 'M');
INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, 'L');
INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, 'XL');
INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, '2XL');
INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, '3XL');
INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, '29');
INSERT INTO `Sizes` (`size_id`, `size_name`) VALUES (NULL, '30');

INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Áo Nam', '1', NULL);
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Quần Nam', '1', NULL);
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Quần Lót Nam', '1', NULL);

INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Áo T-Shirt', '2', '1');
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Áo Polo', '2', '1');
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Áo Sơ Mi', '2', '1');
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Quần Short', '2', '2');
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Quần Jeans', '2', '2');
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Quần Brief (Tam Giác)', '2', '3');
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Quần Trunk (Boxer)', '2', '3');
INSERT INTO `Categories` (`category_id`, `title`, `level`, `parent_id`) VALUES (NULL, 'Quần Brief Boxer (Boxer Dài)', '2', '3');
